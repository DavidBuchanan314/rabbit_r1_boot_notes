"""
Heavily inspired by mktclient (https://github.com/bkerler/mtkclient)
"""
...
class R1Exploit():
	...
	def __init__(self, da_payload, boot_payload, brom=False):
		self.brom = brom
		if brom:
		...
		if self.brom:
			...
			bootimg = open(boot_payload, "rb").read()
...
if __name__ == "__main__":
	R1Exploit(brom=False, da_payload="./webusb/da.bin", boot_payload="./webusb/boot.bin")
